...
# configuration file
execfile('cutoff/config.py')

# these require only the configuration file
execfile('cutoff/mc_iterate.py')
execfile('cutoff/mat_file_format.py')
...
execfile('cutoff/analyze_markov_chain.py')
...
execfile('cutoff/transition_matrix.py')
execfile('cutoff/analyze_graph.py')
